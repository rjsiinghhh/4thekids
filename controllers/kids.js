...
router.get('/bankofcali/:id/edit', (req, res) => {
  Bank.findById(req.params.id, (error, foundBank) => {
    res.render('views/applications/edit.ejs', {
      entry: foundBank,
      currentUser: req.session.currentUser
    })
  })
